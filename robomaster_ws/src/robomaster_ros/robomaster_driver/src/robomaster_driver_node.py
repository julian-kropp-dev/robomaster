...
class RobomasterNode:
    def __init__(self):
        ...
        # Blaster laser
        self._sub_laser = rospy.Subscriber("/laser", Twist, self._laser, queue_size=3)
        
        # Blaster kill
        self._robot.blaster.set_led("255",'on')
        self._sub_shoot = rospy.Subscriber("/shoot", Twist, self._shoot, queue_size=3)
        
        self._robot.gimbal.moveto(0,0,10,10);
